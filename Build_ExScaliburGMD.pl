...
# This script prepares project directory and config files for running ExScaliburGMD pipeline.
############################################################################################
...
use ExScaliburGMD::PrintMenu;
use ExScaliburGMD::GetOpt;
use ExScaliburGMD::BuildProject;
...
my $version = "0.5.0";
my $release_date = "2015-03-31";
my $license = "LGPLv3";
my $desc = "Build project directory and config files for running ExScaliburGMD pipeline";
my $url = "http://exscalibur.cri.uchicago.edu";
