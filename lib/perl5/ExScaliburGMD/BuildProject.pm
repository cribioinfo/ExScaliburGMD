...
package ExScaliburGMD::BuildProject;
...
use ExScaliburGMD::Util qw(Info Parse_Inputfiles Test_Hash Local_Time);
use ExScaliburGMD::GetOpt;
use ExScaliburGMD::ParseMetadata;
use ExScaliburGMD::BuildProjDir;
use ExScaliburGMD::BuildProjCfg;
use ExScaliburGMD::BuildSampleCfg;
use ExScaliburGMD::BuildReportYaml;
use ExScaliburGMD::BuildArchiveYaml;
use ExScaliburGMD::BuildPipelineJob;
...
sub Build_Project
{
  ...
  $config_list = Build_Proj_Cfg($sample_list, $config_list, $proj_dir, $project, $metadata_file, $mapq_min, $threads, $split_flag);
