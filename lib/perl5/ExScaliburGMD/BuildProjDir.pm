...
package ExScaliburGMD::BuildProjDir;
...
use ExScaliburGMD::Util qw(Make_Dir);
...
sub Build_Proj_Dir
{
  ...
  foreach my $dir(qw(alignment alignment_metrics project_report qc_reports variant_calls variant_annotation configs)) {
